...
Perceiver (Jaegle et. al., 2021) is a modifcation to the Transformer Decoder to flexibly handle inputs with large size. In this repository we replicate end-to-end trianing on ImageNet.
